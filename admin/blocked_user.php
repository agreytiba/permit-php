...
$sql = "SELECT COUNT(*) AS total FROM users WHERE users.enabled = 0 ";
...
<h1 class="text-2xl text-center font-bold my-4 pt-4"> Blocked user</h1>
                ...
                <?php foreach ($users as $user) : ?>
                    <tr>
                        ...
                        <td class='border text-center px-4 py-2'>
                            ...
                            <a href="components/user_unblock.php?user_id=<?php echo $user['id']; ?>" class="text-red-500 hover:text-red-800 underline" onclick="return confirm('Are you sure you want to unblock  this user?');">unblock</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
