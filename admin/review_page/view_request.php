        ...
        <div class="bg-white w-3/4 shadow-md rounded p-6 mb-10">
            ...
            <?php if (!empty($workRequests)) : ?>
                <div class="bg-gray-100 mt-10">
                    ...
                    <div class="px-2 py-4">
                        <h2 class="text-center text-2xl font-bold py-2">Review Section</h2>
                        <section class="flex justify-between bg-white">
                            <form action="review_request.php" method="POST" class="flex justify-end py-4 px-4" onsubmit="return confirm('Are you sure you want to review this request?');">
                                <input type="hidden" name="requestId" value="<?php echo htmlspecialchars($workRequests['mainRequestId']); ?>">
                                <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                    Review
                                </button>
                            </form>

                            <form action="decline_request.php" method="POST" class="flex justify-end py-4 px-4" onsubmit="return confirm('Are you sure you want to decline this request?');">
                                <input type="hidden" name="requestId" value="<?php echo htmlspecialchars($workRequests['mainRequestId']);
                                                                                ?>">
