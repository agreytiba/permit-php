...
if (!$user) {
    $navbarItems[] = ['name' => 'Login', 'link' => 'admin/login.php'];
    $navbarItems[] = ['name' => 'Register', 'link' => 'admin/register.php'];
    $navbarItems = [
        ['name' => 'Home', 'link' => '/admin/index.php'],
    ];
} else {
    $navbarItems[] = ['name' => 'home', 'link' => 'index.php'];
}
?>
