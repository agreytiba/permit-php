...
$sql = "SELECT COUNT(*) AS total 
        FROM mainrequests 
        WHERE is_reviewed = 'false' AND permit_status = 'received'";
...
$sql = "SELECT *
        ...
        WHERE mainrequests.is_reviewed = 'false' AND mainrequests.permit_status = 'received'
...
<body class="font-sans bg-gray-200">
    <div class="flex justify-center item-center h-full">
        <div class="w-3/4 bg-white rounded shadow-md h-screen">
            <?php include 'navbar_review.php'; ?>

            <h2 class="text-center text-3xl py-6">Review Page</h2>
            <div class="p-5">
                            ...
                            <?php foreach ($workRequests as $request) : ?>
                                <tr>
                                    ...
                                    <td class='border text-center px-4 py-2'>
                                        <a href="view_request.php?request=<?php echo $request['mainRequestId']; ?>" class="text-blue-500 hover:text-blue-800 underline">Review</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                ...
                <?php else : ?>
                    <p class="text-center text-2xl">No requests found under review.</p>
                <?php endif; ?>
